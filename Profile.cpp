...
void TikTokProfile::initUI() {
    ...
    // 关注按钮
    QPushButton *followBtn = new QPushButton("关注");
    ...
    // 私信按钮
    QPushButton *messageBtn = new QPushButton("私信");
    ...
    statsLayout->addWidget(new StatCard("作品", 24));
    statsLayout->addWidget(new StatCard("粉丝", 15600));
    statsLayout->addWidget(new StatCard("关注", 320));
    infoLayout->addLayout(statsLayout);

    // 个人简介
    QLabel *bioLabel = new QLabel("热爱生活的创作者 · 分享美好瞬间\n合作邮箱：contact@example.com");
    ...
    // 视频标签（当前选中）
    QPushButton *videoTabBtn = new QPushButton("视频");
    ...
    // 喜欢标签（未选中）
    QPushButton *likedTabBtn = new QPushButton("喜欢");
