/****************************************************************************
** Meta object code from reading C++ file 'profile_page.h'
**
...
#error "The header file 'profile_page.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 12, 18), // "playVideoRequested"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 5) // "index"

    },
    "ProfilePage\0playVideoRequested\0\0index"
};
...
void ProfilePage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->playVideoRequested((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ProfilePage::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ProfilePage::playVideoRequested)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ProfilePage::playVideoRequested(int _t1)
{
